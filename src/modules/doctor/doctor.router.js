...
//profile
router.get("/home/profile/:doctorId",doctorController.profile)
...
router.get("/getPatients/:doctorId",doctorController.getDataPatients)

//router.get("/getHistory",authDoctor,doctorController.getHistorySeizures)

router.get("/getHistory/:patientId",doctorController.getHistorySeizure)
router.get("/getOnePatient/:patientId",doctorController.getDataOnePatient)
...
router.post('/logoutDoctor/:doctorId',
